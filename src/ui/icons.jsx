...
const PATHS = {
  ...
  book: <><path d="M12 7.5v12" /><path d="M12 7.5C10.6 6.2 8.8 5.5 6.5 5.5H4a.5.5 0 0 0-.5.5v11a.5.5 0 0 0 .5.5h2.5c2.3 0 4.1.7 5.5 2 1.4-1.3 3.2-2 5.5-2H20a.5.5 0 0 0 .5-.5V6a.5.5 0 0 0-.5-.5h-2.5c-2.3 0-4.1.7-5.5 2Z" /></>,
