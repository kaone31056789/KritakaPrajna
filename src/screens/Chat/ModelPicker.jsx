...
import { NeuPopover, GradientOrb, NeuBadge } from "../../ui/primitives";

/* Model picker popover — search, grouped by provider, price + context chips. */
      ...
      <div className="max-h-[380px] overflow-y-auto p-1.5">
        ...
        {groups.map(([provider, list]) => (
          <div key={provider}>
            ...
            {list.map((m) => {
              const active = m._selectionId === selectedId;
              return (
                <button
                  key={m._selectionId}
                  type="button"
                ...
                >
                  <GradientOrb seed={m._selectionId} size={18} />
